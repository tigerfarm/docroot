...
document.write('        <div class="bar6" onclick="menubar()"></div>');
document.write('        <div class="bar7" onclick="menubar()"></div>');
document.write('    </div>');
...
document.write('            <a href="/tigchat/docroot/index.html">Chat</a>');
document.write('        </div>');
document.write('    </div>');
document.write('</td>');
document.write('<td>');
...
document.write('        <div id="topImgRight"><a href="/pages/about.html">Author: Stacy David</a></div>');
document.write('    </div>');
document.write('</td>');
document.write('</tr>');
document.write('</table>');
